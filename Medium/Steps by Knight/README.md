<h2><a href="https://practice.geeksforgeeks.org/problems/steps-by-knight5927/1?page=1&category[]=Graph&sortBy=submissions">Steps by Knight</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a square chessboard, the initial position of Knight and position of a target. Find out the minimum steps a Knight will take to reach the target position.</span></p>
